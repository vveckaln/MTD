...
class TrackExtenderTest : public edm::one::EDAnalyzer<edm::one::SharedResources> {
public:
  explicit TrackExtenderTest(const edm::ParameterSet&);
  ~TackExtenderTest();
...
TrackExtenderTest::TrackExtenderTest(const edm::ParameterSet& iConfig)
...
TrackExtenderTest::~TrackExtenderTest() {}
...
void TrackExtenderTest::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace std;
...
void TrackExtenderTest::beginJob() {}

// ------------ method called once each job just after ending the event loop  ------------
void TrackExtenderTest::endJob() {}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
// void MTDRecoDump::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(TrackExtenderTest);
